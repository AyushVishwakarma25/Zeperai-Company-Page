      ...
      <section className="py-20 px-6">
        <div className="container mx-auto max-w-4xl space-y-12 text-white/80 leading-relaxed">
          ...
          >
            ...
            <h3 className="text-2xl font-semibold mt-6 mb-4 text-white/90">Personal Data</h3>
            <p>Name, email address, and contact details provided when you inquire about our services.</p>
            
            <h3 className="text-2xl font-semibold mt-6 mb-4 text-white/90">Business Data</h3>
            <p>Information about your brand, assets, and marketing goals shared during project onboarding.</p>
            
            <h3 className="text-2xl font-semibold mt-6 mb-4 text-white/90">Usage Data</h3>
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-white">3. AI Processing &amp; Data Security</h2>
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-white">4. Third-Party Sharing</h2>
          ...
          >
            ...
            <p className="mt-4">To exercise these rights, please contact us at <a href="mailto:reahtoayush25@gmail.com" className="text-blue-400 hover:text-blue-300">reahtoayush25@gmail.com</a>.</p>
          </motion.div>
        </div>
      </section>
