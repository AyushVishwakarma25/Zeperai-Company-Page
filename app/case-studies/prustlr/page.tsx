...
export default function PrustlrCaseStudy() {
  return <main className="min-h-screen overflow-hidden bg-[#f5f5f7] text-[#0A0A0B]">
    ...
    <section className="px-6 py-24 md:px-10 md:py-32"><div className="mx-auto max-w-7xl rounded-[2rem] bg-[#4452FB] px-7 py-14 text-center text-white md:px-16 md:py-20"><p className="mb-5 text-xs font-semibold uppercase tracking-[.25em] text-white/70">Make your next launch impossible to ignore</p><h2 className="mx-auto max-w-3xl font-poppins text-4xl font-semibold leading-tight md:text-6xl">Give your product the system it deserves.</h2><Link href="/booking" className="mt-9 inline-flex items-center gap-2 rounded-full bg-[#0A0A0B] px-6 py-4 text-sm font-semibold text-white">Start your growth system <ArrowUpRight className="h-4 w-4" /></Link></div></section>
    <Footer />
  </main>
}
