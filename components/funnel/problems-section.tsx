        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {problems.map((problem, i) => (
            <motion.div
              ...
              className="group relative bg-gradient-to-br from-red-950/20 to-red-900/10 border-2 border-red-900/50 hover:border-red-700/80 rounded-2xl p-6 transition-all hover:shadow-lg hover:shadow-red-950/50"
            >
